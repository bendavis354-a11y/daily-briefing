...
// Priority 1 is the highest, so this sorts ascending: item 1 of the document is
// the item that matters most. Equal priorities keep the order the analysis step
// chose (Array#sort is stable).
